...
public interface DriverRepository extends JpaRepository<Driver, String> {
    ...
    List<Driver> findByLicensePlateStartingWith(String prefix);
    boolean existsByLicensePlate(String licensePlate);

    // Optional: You can also add this if you want a more direct delete method
    @Modifying
    @Transactional
    @Query("DELETE FROM Driver d WHERE d.licensePlate LIKE :prefix%")
    void deleteByLicensePlateStartingWith(@Param("prefix") String prefix);
